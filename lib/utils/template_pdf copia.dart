                              ...
                              child: pw.Padding(
                                  ...
                                  child: pw.Column(
                                    children: [
                                      ...
                                      pw.Text('Tel. 0123.4567890',
                                          style: pw.TextStyle(fontSize: 8)),
                                      pw.Text('Cod.Fisc.:01234567890',
                                          style: pw.TextStyle(fontSize: 8)),
                                      pw.Text('P.Iva:01234567890',
                                          style: pw.TextStyle(fontSize: 8)),
                                    ],
                                  )))),
                      pw.SizedBox(width: 2),
  ...
  if (mapRighe.isNotEmpty) {
    for (var mapRiga in mapRighe) {
      ...
      if (mapRiga["MBIV_IVA"].toString() != controlloAliquota) {
        ...
        imponibile += mapRiga["FTAR_Prezzo"];
      }

      colli += mapRiga["FTAR_Quantita"];
      if (mapRiga["FTAR_MBTA_Codice"] == 5) {
        omaggi = omaggi + mapRiga["FTAR_Prezzo"];
      }
      ...
      righe.add([
        ...
        mapRiga["FTAR_MBTA_Codice"] == 5
            ? 'Omaggio'
            : mapRiga["FTAR_Prezzo"].toStringAsFixed(2).toString(),
        (mapRiga["FTAR_Quantita"] *
                    (mapRiga["FTAR_Prezzo"] - mapRiga["FTAR_TotSconti"]))
                ?.toString() ??
            '',
        '${mapRiga["MBIV_IVA"] ?? '0'} %',
      ]);
